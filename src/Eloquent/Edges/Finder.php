...
class Finder extends Delegate {
     ...
     *
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model  $parentModel
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model  $relatedModel
     ...
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model  $relatedModel
     * @param  string $direction
     * @return \VahidIrn\NeoEloquent\Eloquent\Edges\Edge[In|Out]|null
     */
     ...
     * @return \VahidIrn\NeoEloquent\Eloquent\Edges\HyperEdge
     */
     ...
     * @param  \Everyman\Neo4j\Relationship $relation
     * @param  string $direction
     * @return \VahidIrn\NeoEloquent\Eloquent\Edges\Edge[In|Out]
     */
