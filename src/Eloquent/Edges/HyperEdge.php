...
use VahidIrn\NeoEloquent\Eloquent\Edges\Relation;
...
class HyperEdge extends Relation {
     ...
     *
     * @var \VahidIrn\NeoEloquent\Eloquent\Model
     */
    protected $morph;
     ...
     *
     * @var \VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut
     */
    protected $left;
     ...
     * @param VahidIrn\NeoEloquent\Eloquent\Model   $morph
     */
     ...
     * @return void
     *
     * @throws  \VahidIrn\NeoEloquent\NoEdgeDirectionException If $direction is not set on the inheriting relation.
     */
     ...
     *
     * @return \VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut
     */
     ...
     *
     * @param \VahidIrn\NeoEloquent\Eloquent\Edges\Relation $left
     * @return  void
     */
     ...
     *
     * @param \VahidIrn\NeoEloquent\Eloquent\Edges\Relation $right
     * @return void
     */
