...
class Builder extends IlluminateBuilder {
     ...
     *
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model $parent       The parent model
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \VahidIrn\NeoEloquent\Query\Builder|static
     */
     ...
     * @param  \VahidIrn\NeoEloquent\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \VahidIrn\NeoEloquent\Eloquent|static
     */
     ...
     *
     * @param string $holder
     * @param \VahidIrn\NeoEloquent\Eloquent\Model|string  $model String in the case of morphs where we do not know
     ...
     *
     * @param  string $mutation
     * @return \VahidIrn\NeoEloquent\Eloquent\Model
     */
     ...
     *
     * @param  \VahidIrn\NeoEloquent\Eloquent\Relations\* $relation
     * @return [type]
     */
