...
use VahidIrn\NeoEloquent\Schema\Grammars\CypherGrammar;
...
class NeoEloquentServiceProvider extends ServiceProvider {
    ...
    public function register()
    {
        ...
        $this->app->resolving(function($app){
            if (class_exists('Illuminate\Foundation\AliasLoader')) {
                ...
                $loader->alias('NeoEloquent', 'VahidIrn\NeoEloquent\Eloquent\Model');
                $loader->alias('Neo4jSchema', 'VahidIrn\NeoEloquent\Facade\Neo4jSchema');
            }
        });
    ...
    */
    ...
    {
        $this->app->register('VahidIrn\NeoEloquent\MigrationServiceProvider');
    }
