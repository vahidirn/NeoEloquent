<?php namespace VahidIrn\NeoEloquent\Tests;
...
class ConnectionTest extends TestCase {
    ...
    public function testConnection()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Connection', $c);
    }
    ...
    public function testGettingQueryCypherGrammar()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar', $grammar);
    }
    ...
    public function testPrepareBindings()
    {
        ...
        $grammar = m::mock('VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar');
    ...
    {
        $conn = $this->getMockConnection();
        $conn->setQueryGrammar(M::mock('VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar')->makePartial());
        $conn->setPostProcessor(M::mock('Illuminate\Database\Query\Processors\Processor')->makePartial());
        $builder = $conn->table('User');
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Query\Builder', $builder);
    ...
    protected function getMockConnection($methods = array())
    {
        ...
        return $this->getMockBuilder(\VahidIrn\NeoEloquent\Connection::class)
