<?php namespace VahidIrn\NeoEloquent\Tests\Query;

use Illuminate\Database\Query\Processors\Processor;
use Mockery as M;
use VahidIrn\NeoEloquent\Query\Builder;
...
class QueryBuilderTest extends TestCase {
    ...
    public function setUp()
    {
        ...
        $this->grammar    = M::mock('VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar')->makePartial();
        $this->connection = M::mock('VahidIrn\NeoEloquent\Connection');
    ...
    {
        $connection = m::mock('VahidIrn\NeoEloquent\Connection');
        ...
        $builder = $this->getMock('VahidIrn\NeoEloquent\Query\Builder', array('getFresh'), array($connection, $grammar));
