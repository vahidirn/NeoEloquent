<?php namespace VahidIrn\NeoEloquent\Tests\Eloquent\Relations;
...
class BelongsToTest extends TestCase  {
    ...
    public function testRelationInitializationAddsConstraints()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Relations\BelongsTo', $relation);
    }

    public function testUpdateMethodRetrievesModelAndUpdates()
    {
        $relation = $this->getRelation();
        $mock = M::mock('VahidIrn\NeoEloquent\Eloquent\Model');
    ...
    protected function getEagerRelation($models)
    {
        ...
        $builder = M::mock('VahidIrn\NeoEloquent\Eloquent\Builder');
        ...
        $related = M::mock('VahidIrn\NeoEloquent\Eloquent\Model')->makePartial();
