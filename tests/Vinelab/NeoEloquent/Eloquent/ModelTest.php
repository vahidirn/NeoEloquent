...
class ModelTest extends TestCase {
    ...
    public function testDefaultNodeLabel()
    {
        ...
        $this->assertEquals('VahidIrnNeoEloquentTestsEloquentModel', reset($label));
    }
    ...
    public function testGettingEloquentBuilder()
    {
        ...
        $builder = $m->newEloquentBuilder(M::mock('VahidIrn\NeoEloquent\Query\Builder'));

        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Builder', $builder);
    }
