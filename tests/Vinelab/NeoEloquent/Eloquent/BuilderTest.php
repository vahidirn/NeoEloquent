<?php namespace VahidIrn\NeoEloquent\Tests\Eloquent;

use Mockery as M;
use Illuminate\Support\Collection;
use VahidIrn\NeoEloquent\Tests\TestCase;
use VahidIrn\NeoEloquent\Eloquent\Builder;
use VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar;
...
class EloquentBuilderTest extends TestCase {
    ...
    public function setUp()
    {
        ...
        $this->query = M::mock('VahidIrn\NeoEloquent\Query\Builder');
        $this->query->shouldReceive('modelAsNode')->andReturn('n');
        $this->model = M::mock('VahidIrn\NeoEloquent\Eloquent\Model');
    ...
    {
        $builder = M::mock('VahidIrn\NeoEloquent\Eloquent\Builder[first]', array($this->getMockQueryBuilder()));
    ...
    {
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[get]', array($this->getMockQueryBuilder()));
        $builder->setModel($this->getMockModel());
    ...
    {
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[get,take]', array($this->getMockQueryBuilder()));
    ...
    {
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[getModels,eagerLoadRelations]', array($this->getMockQueryBuilder()));
    ...
    public function testPluckMethodWithModelFound()
    {
        ...
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[first]', array($queryBuilder));
    ...
    {
        $this->markTestIncomplete('Getting error: BadMethodCallException: Method Mockery_1_VahidIrn_NeoEloquent_Query_Builder::orderBy() does not exist on this mock object');
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[forPage,get]', array($this->getMockQueryBuilder()));
    ...
    public function testGetModelsProperlyHydratesModels()
    {
        ...
        $builder = M::mock('VahidIrn\NeoEloquent\Eloquent\Builder[get]', array($query));
        ...
        $grammar = M::mock('VahidIrn\NeoEloquent\Query\Grammars\CypherGrammar')->makePartial();
        $builder->getQuery()->shouldReceive('getGrammar')->andReturn($grammar);

        $model = M::mock('VahidIrn\NeoEloquent\Eloquent\Model[getTable,getConnectionName,newInstance]');
    ...
    {
        $builder = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder[eagerLoadRelation]', array($this->getMockQueryBuilder()));
        $nop1 = function() {};
        $nop2 = function() {};
    ...
    public function testQueryPassThru()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Builder', $builder->foobar());
    ...
    {
        $this->markTestIncomplete('Getting error: Static method Mockery_1_VahidIrn_NeoEloquent_Eloquent_Model::resolveConnection() does not exist on this mock object');

        $nestedQuery = m::mock('VahidIrn\NeoEloquent\Eloquent\Builder');
    ...
    {
        $this->markTestIncomplete('Getting the error BadMethodCallException: Method Mockery_2_VahidIrn_NeoEloquent_Query_Builder::onDelete() does not exist on this mock object');
        $builder = $this->getBuilder();
    ...
    {
        $model = m::mock('VahidIrn\NeoEloquent\Eloquent\Model');
    ...
    {
        $query = m::mock('VahidIrn\NeoEloquent\Query\Builder');
...
class EloquentBuilderTestModelStub extends \VahidIrn\NeoEloquent\Eloquent\Model {}

class EloquentBuilderTestScopeStub extends \VahidIrn\NeoEloquent\Eloquent\Model {
