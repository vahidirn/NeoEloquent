<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo;
...
class PolymorphicHyperMorphToTest extends TestCase {
    ...
    public function testCreatingUserCommentOnPostAndVideo()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\HyperEdge', $postComment);
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $postComment->left());
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $postComment->right());
        $this->assertTrue($postComment->exists());

        $videoComment = $videoCommentor->comments($video)->create(['text' => 'Haha, hilarious shit!']);
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\HyperEdge', $videoComment);
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $videoComment->left());
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $videoComment->right());
    ...
    public function testAttachingManyIds()
    {
        ...
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\HyperEdge', $comment);
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $comment->left());
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $comment->right());
    ...
    public function testDynamicLoadingMorphedModel()
    {
        ...
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Comment', $comment);
            $this->assertTrue($comment->exists);
    ...
    public function testDynamicLoadingMorphToModel()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Post', $commentablePost);
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Video', $commentableVideo);
    ...
    public function testEagerLoadingMorphToModel()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Post', $morphedCommentRelations['commentable']);
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Video', $morphedVideoCommentRelations['commentable']);
...
class User extends Model {
    ...
    {
        return $this->hyperMorph($model, 'VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Comment', 'COMMENTED', 'ON');
    }

    public function posts()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Post', 'POSTED');
    }

    public function videos()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Video', 'UPLOADED');
    }
}
...
class Post extends Model {
    ...
    {
        return $this->morphMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Comment', 'ON');
    }
}
...
class Comment extends Model {
    ...
    {
        return $this->morphTo('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Post', 'ON');
    }

    public function video()
    {
        return $this->morphTo('VahidIrn\NeoEloquent\Tests\Functional\Relations\HyperMorphTo\Video', 'ON');
    }
}
