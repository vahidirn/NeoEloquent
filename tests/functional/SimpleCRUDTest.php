<?php namespace VahidIrn\NeoEloquent\Tests\Functional;
...
class SimpleCRUDTest extends TestCase {
     ...
     * @see https://github.com/VahidIrn/NeoEloquent/issues/27
     */
    ...
    public function testCreatingRecord()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Wiz', $w);
    }
     ...
     *
     * @see  https://github.com/VahidIrn/NeoEloquent/issues/18
    ...
    public function testInsertingBatch()
    {
        ...
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Wiz', $wizz);
            $values = $wizz->toArray();
