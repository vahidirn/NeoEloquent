<?php namespace VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations;

use DateTime;
use Mockery as M;
use Carbon\Carbon;
use VahidIrn\NeoEloquent\Tests\TestCase;
...
class QueryingRelationsTest extends TestCase {
    ...
    public function testQueryingWhereHasById()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', $found);
    ...
    public function testCreatingModelWithSingleRelation()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', $user);
        $this->assertTrue($user->exists);
        $this->assertGreaterThanOrEqual(0, $user->id);

        $related = $user->account;
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Account', $related);
    ...
    public function testCreatingModelWithRelations()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Role', $role);
        $this->assertTrue($role->exists);
        $this->assertGreaterThanOrEqual(0, $role->id);

        foreach ($role->permissions as $key => $permission)
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Permission', $permission);
    ...
    public function testCreatingModelWithMultipleRelationTypes()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Post', $post);
        $this->assertTrue($post->exists);
        $this->assertGreaterThanOrEqual(0, $post->id);

        foreach ($post->photos as $key => $photo)
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Photo', $photo);
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Video', $video);
    ...
    public function testCreatingModelWithSingleInverseRelation()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Account', $account);
     ...
     *
     * @see  https://github.com/VahidIrn/NeoEloquent/issues/17
     */
    ...
    public function testCreatingModelWithMixedRelationsAndPassingCollection()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Post', $another);
        $this->assertEquals(3, count($related));
    }

    /**
     * Regression for issue #9
     * @see https://github.com/VahidIrn/NeoEloquent/issues/9
     */
     ...
     *
     * @see https://github.com/VahidIrn/NeoEloquent/issues/7
     */
    ...
    public function testInverseEagerLoadingOneNestedRelationship()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Role', $roleFound);
    ...
    public function testQueryingRelatedModel()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Role', $readFound);
...
class User extends Model {
    ...
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Role', 'PERMITTED');
    }

    public function account()
    {
        return $this->hasOne('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Account', 'ACCOUNT');
    }

    public function colleagues()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', 'COLLEAGUE_OF');
    }

    public function organization()
    {
        return $this->belongsTo('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Organization', 'MEMBER_OF');
    }
}
...
class Account extends Model {
    ...
    {
        return $this->belongsTo('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', 'ACCOUNT');
    }
}
...
class Organization extends Model {
    ...
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', 'MEMBER_OF');
    }
}
...
class Role extends Model {
    ...
    {
        return $this->belongsToMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\User', 'PERMITTED');
    }

    public function permissions()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Permission', 'ALLOWS');
    }
}
...
class Permission extends Model {
    ...
    public function roles()
    {
        return $this->belongsToMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Role', 'ALLOWS');
    }
}
...
class Post extends Model {
    ...
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Photo', 'PHOTO');
    }

    public function cover()
    {
        return $this->hasOne('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Photo', 'COVER');
    }

    public function videos()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Video', 'VIDEO');
    }

    public function comments()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Comment', 'COMMENT');
    }

    public function tags()
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Tag', 'TAG');
    }
}
...
class Comment extends Model {
    ...
    {
        return $this->belongsTo('VahidIrn\NeoEloquent\Tests\Functional\QueryingRelations\Post', 'COMMENT');
    }
}
