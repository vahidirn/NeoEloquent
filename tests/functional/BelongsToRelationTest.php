<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsTo;
...
class Location extends Model {
    ...
    {
        return $this->belongsTo('VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsTo\User', 'LOCATED_AT');
    }
}
...
class BelongsToRelationTest extends TestCase {
    ...
    public function testRetrievingAssociationFromParentModel()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeIn', $retrieved);
    ...
    public function testSavingMultipleAssociationsKeepsOnlyTheLastOne()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeIn', $withJan);
