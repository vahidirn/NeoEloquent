<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Relations\HasOne;
...
class User extends Model {
    ...
    {
        return $this->hasOne('VahidIrn\NeoEloquent\Tests\Functional\Relations\HasOne\Profile', 'PROFILE');
    }
}
...
class HasOneRelationTest extends TestCase {
    ...
    public function testDynamicLoadingHasOne()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $relation);
    ...
    public function testRetrievingRelationWithAttributesSpecifyingEdgeModel()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $retrieved);
    ...
    public function testSavingMultipleRelationsKeepsOnlyTheLastOne()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $withCv);
