<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Relations\HasMany;
...
class Author extends Model {
    ...
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\HasMany\Book', 'WROTE');
    }
}
...
class HasManyRelationTest extends TestCase {
    ...
    public function testSavingSingleAndDynamicLoading()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $writtenGot);
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $writtenCok);
    ...
    public function testSavingManyAndDynamicLoading()
    {
        ...
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $edge);
