<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Events;
...
class User extends Model {
    ...
    {
        return $this->hasMany('VahidIrn\NeoEloquent\Tests\Functional\Events\Cake', 'HAS_CAKE');
    }
    public function singleCake()
    {
        return $this->hasOne('VahidIrn\NeoEloquent\Tests\Functional\Events\Cake', 'HAS_SINGLE_CAKE');
    }
