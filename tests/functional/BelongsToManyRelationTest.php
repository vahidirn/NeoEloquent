<?php namespace VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsToMany;
...
class User extends Model {
    ...
    {
        return $this->belongsToMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsToMany\Role', 'HAS_ROLE');
    }
}
...
class Role extends Model {
    ...
    {
        return $this->belongsToMany('VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsToMany\User', 'HAS_ROLE');
    }
}
...
class BelongsToManyRelationTest extends TestCase {
    ...
    public function testSavingRelatedBelongsToMany()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeIn', $relation);
    ...
    public function testFindingBothEdges()
    {
        ...
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeIn', $edgeIn);
        $this->assertTrue($edgeIn->exists());
        $this->assertGreaterThan(0, $edgeIn->id);

        $edgeIn = $role->users()->edge($user);
        $this->assertInstanceOf('VahidIrn\NeoEloquent\Eloquent\Edges\EdgeOut', $edgeIn);
        $this->assertTrue($edgeIn->exists());
        $this->assertGreaterThan(0, $edgeIn->id);
    ...
    public function testDynamicLoadingBelongsToManyRelatedModels()
    {
        ...
        {
            $this->assertInstanceOf('VahidIrn\NeoEloquent\Tests\Functional\Relations\BelongsToMany\Role', $role);
